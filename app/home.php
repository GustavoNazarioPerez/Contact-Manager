...
<body>
  ...
  <script>
    ...
    function onSearch(){
      ...
      // turn searchBar text into array of first and last name
      let searchBarTextArr = searchBar.split(" ");

      // collect first and last name from a search bar
      let firstName = searchBarTextArr[0];
      let lastName = searchBarTextArr[1];
